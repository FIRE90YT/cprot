...
import vpsConfig from "./vps.json"
    ...
    <section className="bg-black relative py-16 px-4 sm:px-6 lg:px-8 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          >
            Lo <span className="text-blue-500">MINIMO recomendable</span>
          </h1>
          <p 
            className="text-gray-200 text-s tracking-wider mb-2"
          >
            Estos son los planes que se recomiendan para un servidor de minecraft.
          </p>
        </div>
